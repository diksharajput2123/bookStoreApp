    ...
    return(
        <>
          <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-20">
            <div className="order-2 md:order-1 w-full md:w-1/2 mt-6 md:mt-33">
                ...
                btn-secondary">Enter</button>
            </div>
            <div className="order-1 md:order-2 w-full md:w-1/2 md:flex md:justify-center md:items-center">
